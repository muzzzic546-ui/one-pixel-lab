...
I asked for a first version with two sliders (top brightness and bottom brightness) and a Safe/Bold label based on the gap between them.

## A confusion moment

The first version only showed the label, so I asked Claude Code to also display the numerical gap and the 100-point threshold as evidence.
